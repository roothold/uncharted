  ...
  return (
    <div style={{ backgroundColor:C.bg, color:C.ink, minHeight:"100vh", fontFamily:"'Inter Tight', sans-serif" }}>
      ...
      <nav style={{ position:"fixed", top:0, left:0, right:0, zIndex:100,
        backgroundColor:"#FFFFFF", borderBottom:`1px solid ${C.border}`, padding:"0" }}>
      ...
      <div style={{ borderBottom:`1px solid ${C.border}`, paddingTop:"56px" }}>
        <div style={{ maxWidth:"1280px", margin:"0 auto", padding:"5rem 2.5rem 3.5rem" }} className="ind-px">
      ...
      <footer style={{ borderTop:`1px solid ${C.border}` }}>
        <div style={{ maxWidth:"1280px", margin:"0 auto", padding:"1.75rem 2.5rem",
