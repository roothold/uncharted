    ...
    <div style={{ backgroundColor:C.bg, color:C.ink, minHeight:"100vh", overflowX:"hidden" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        @media(max-width:768px) {
          ...
          .hero-inner p  { max-width:100%; margin-left:auto; margin-right:auto; }
      ...
      <section style={{ minHeight:"100vh", display:"flex", flexDirection:"column", justifyContent:"center", padding:"10rem 3rem 6rem" }} className="px-main hero-top">
        <div style={{ maxWidth:"1200px", margin:"0 auto", width:"100%" }}>
          ...
          <h1 style={{ fontFamily:"'Instrument Serif', serif", fontWeight:600, fontSize:"clamp(2.4rem, 8vw, 6.8rem)", lineHeight:1.05, color:C.ink, marginBottom:"2.5rem", opacity:0, animation:"fadeUp 0.8s 0.2s forwards" }}>
            We build and back<br />companies that last.
          </h1>
          <p style={{ fontFamily:"'Inter Tight', sans-serif", fontWeight:300, fontSize:"clamp(1rem, 2vw, 1.1rem)", lineHeight:1.85, color:C.inkMid, marginBottom:"3.5rem", opacity:0, animation:"fadeUp 0.8s 0.35s forwards" }}>
